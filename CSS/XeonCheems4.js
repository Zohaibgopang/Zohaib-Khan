...
module.exports = zohaib = async (XeonBotInc, m, chatUpdate, store) => {
    try {
	...
	if (isBanChat) return reply(mess.banChat)
        ...
        if (stderr.trim()) reply(stderr)
            ...
            case 'owner': case 'creator': {
                Zohaib Khan.sendContact(m.chat, global.vcardowner, m)
            }
            break
  case 'setmenu': {
            	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                Zohaib .sendListMsg(m.chat, `Please select the menu you want to change!`, ` `, XeonBotInc.user.name, `Click Here`, sections, m)
                }
            }
            break
case 'request': {
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                        ...
                        /////////Zohaibkhan.send5ButMsg(m.chat, menulist, global.botname, btn)
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            Zohaib Khan.relayMessage(m.chat, template.message, { messageId: template.key.id })
            }
            break
case 'allmenu':
	   if (isBan) return reply(mess.ban)
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 OWNER 」	
╠ ${prefix}self
╠ ${prefix}public
╠ ${prefix}antitag
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 GROUP 」	
╠${prefix}groupsetting
╠${prefix}grouplink
╠${prefix}ephemeral [option]
╠${prefix}setgcpp [image]
...
await Zohab Khan.send5ButImg(from, `╔═══════✪「 RPG 」	
╠${prefix}hunt
╠${prefix}mine
╠${prefix}fish
╠${prefix}heal
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 MAKER 」	
╠${prefix}candy
╠${prefix}8bit
╠${prefix}horror
╠${prefix}hoorror
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 DOWNLOAD 」	
╠${prefix}instagram [url]
╠${prefix}igtv [url]
╠${prefix}igstory [username]
╠${prefix}facebook [url]
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 SEARCH 」	
╠${prefix}play [query]
╠${prefix}song [query]
╠${prefix}yts [query]
╠${prefix}lyrics [query]
...
await Zohiab Khan.send5ButImg(from, `╔═══════✪「 CONVERT 」	
╠ ${prefix}toimage [reply stick]
╠ ${prefix}sticker [reply img|gif]
╠ ${prefix}take [reply img|gif|stik]
╠ ${prefix}smeme [reply img]
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 RANDOM IMG 」	
╠${prefix}coffee
╠${prefix}bts
╠${prefix}woof
╠${prefix}meow
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 EMOTE 」	
╠${prefix}instagramemoji
╠${prefix}facebookemoji
╠${prefix}iphoneemoji
╠${prefix}samsungemoji
...
await Zohaib Khan.send5ButImg(from, `╔═════✪「 IMG EFFECT 」	
╠${prefix}wanted
╠${prefix}blur
╠${prefix}framed
╠${prefix}gayeffect
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 ANIME 」	
╠${prefix}naruto
╠${prefix}yaoi
╠${prefix}neko2
╠${prefix}waifu
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 STICKER 」	
╠ ${prefix}patrick
╠ ${prefix}emoji
╠ ${prefix}emojimix
╠ ${prefix}attp
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 ANIME STICKER 」	
╠${prefix}loli
╠${prefix}bully
╠${prefix}cuddle
╠${prefix}cry
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 NSFW 」	
╠${prefix}hentaivideo
╠${prefix}yuri
╠${prefix}masturbation
╠${prefix}thighs
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 Fun 」	
╠ ${prefix}how [text
╠ ${prefix}when [text]
╠ ${prefix}where [text]
╠ ${prefix}is [text]
...
await Zohaib Khan.send5ButImg(from, `╔═══════✪「 Sound 」	
╠ ${prefix}sound1
╠ ${prefix}sound2
╠ ${prefix}sound3
╠ ${prefix}sound4
...
await zohaib.send5ButImg(from, `╔═══════✪「 GAME 」	
╠ ${prefix}truth
╠ ${prefix}dare
╠ ${prefix}tictactoe
╠ ${prefix}delttt
...
await zohaib.send5ButImg(from, `╔═══✪「 ANONYMOUS 」	
╠${prefix}anonymous
╠${prefix}start
╠${prefix}next
╠${prefix}leave
...
await zohaib.send5ButImg(from, `╔═══════✪「 TOOL 」	
╠ ${prefix}translate [text]
╠ ${prefix}fliptext [text]
╠ ${prefix}toletter [number]
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
...
await zohaib.send5ButImg(from, `╔═══✪「 DATABASE 」	
╠ ${prefix}setcmd
╠ ${prefix}listcmd
╠ ${prefix}delcmd
╠ ${prefix}lockcmd
